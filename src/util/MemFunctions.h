...
#ifndef _MEMFUNCTIONS
#define _MEMFUNCTIONS
...
// forward declaration
class BaseRecvFragDesc_t;

/* function prototypes */
unsigned long bcopy_csum (const void * RESTRICT_MACRO source, void * RESTRICT_MACRO destination,
                          unsigned long copylen, unsigned long csumlen);
unsigned long bcopy_csum (const void * RESTRICT_MACRO source, void * RESTRICT_MACRO destination,
                          unsigned long copylen, unsigned long csumlen,
                          unsigned long * RESTRICT_MACRO lastPartialLong, unsigned long * RESTRICT_MACRO lastPartialLength);
unsigned long csum (const void * RESTRICT_MACRO source, unsigned long csumlen);
unsigned long csum (const void * RESTRICT_MACRO source, unsigned long csumlen,
                    unsigned long * RESTRICT_MACRO lastPartialLong, unsigned long * RESTRICT_MACRO lastPartialLength);

unsigned int bcopy_uicsum (const void * RESTRICT_MACRO source, void * RESTRICT_MACRO destination,
                           unsigned long copylen, unsigned long csumlen);
unsigned int bcopy_uicsum (const void * RESTRICT_MACRO source, void * RESTRICT_MACRO destination,
                           unsigned long copylen, unsigned long csumlen,
                           unsigned int * RESTRICT_MACRO lastPartialInt, unsigned int * RESTRICT_MACRO lastPartialLength);
