                               ...
                               MPI_Fint *rc)
{
    ...
    *rc = MPI_Type_hvector(*count, *blocklength, *stride,
                           c_type_old, &c_type_new);

    if (*rc == MPI_SUCCESS) {
        /* save true combiner value */
        type = c_type_new;
        type->envelope.combiner = MPI_COMBINER_HVECTOR_INTEGER;
...
void PMPI_TYPE_CREATE_HVECTOR(MPI_Fint *count, MPI_Fint *blocklength,
                              MPI_Aint *stride, MPI_Fint *f_type_old,
                              MPI_Fint *f_type_new, MPI_Fint *rc)
{
    mpi_type_create_hvector_f(count, blocklength, stride,
                              f_type_old, f_type_new, rc);
}
...
void pmpi_type_create_hvector_(MPI_Fint *count, MPI_Fint *blocklength,
                               MPI_Aint *stride, MPI_Fint *f_type_old,
                               MPI_Fint *f_type_new, MPI_Fint *rc)
{
    mpi_type_create_hvector_f(count, blocklength, stride,
...
void pmpi_type_create_hvector__(MPI_Fint *count, MPI_Fint *blocklength,
                                MPI_Aint *stride, MPI_Fint *f_type_old,
                                MPI_Fint *f_type_new, MPI_Fint *rc)
{
    mpi_type_create_hvector_f(count, blocklength, stride,
...
void MPI_TYPE_CREATE_HVECTOR(MPI_Fint *count, MPI_Fint *blocklength,
                             MPI_Aint *stride, MPI_Fint *f_type_old,
                             MPI_Fint *f_type_new, MPI_Fint *rc)
{
    mpi_type_create_hvector_f(count, blocklength, stride,
...
void mpi_type_create_hvector_(MPI_Fint *count, MPI_Fint *blocklength,
                              MPI_Aint *stride, MPI_Fint *f_type_old,
                              MPI_Fint *f_type_new, MPI_Fint *rc)
{
    mpi_type_create_hvector_f(count, blocklength, stride,
...
void mpi_type_create_hvector__(MPI_Fint *count, MPI_Fint *blocklength,
                               MPI_Aint *stride, MPI_Fint *f_type_old,
                               MPI_Fint *f_type_new, MPI_Fint *rc)
{
    mpi_type_create_hvector_f(count, blocklength, stride,
