...
extern "C" int PMPI_Allgather(void *sendbuf, int sendcount, MPI_Datatype senddatatype,
                   ...
                   MPI_Comm comm)
{
    ...
    rc = communicator->collective.allgather(sendbuf, sendcount, (ULMType_t *)sendtype,
                                   recvbuf, recvcount, (ULMType_t *)recvtype, comm);
