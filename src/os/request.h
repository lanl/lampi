...
//   void add_constraints_from_file(FILE *)
//   void map_resources()
//
...
public:
    ...
    //
    // get constraint info from a file
    //
    inline void
        add_constraints_from_file(char *fn) {
        FILE *f = fopen(fn, "r"); // should do some error checking somewhere here
        MD_add_contraints_from_file(f);
        fclose(f);
    }
...
private:
    ...
    //    void MD_add_constraints_from_file(FILE *)
