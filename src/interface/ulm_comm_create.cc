...
extern "C" int ulm_comm_create(int comm, int group, int *newComm)
{
	...
	*newComm = MPI_COMM_NULL;
    ...
    // create comunicator
    returnValue = ulm_communicator_alloc(*newComm, communicators[comm]->useThreads,
                                         group, group, false, 0, (int *) NULL, Communicator::INTRA_COMMUNICATOR,
                                         true, 1, communicators[comm]->useSharedMemForCollectives);
BarrierTag:
