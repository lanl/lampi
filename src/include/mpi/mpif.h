...
!     contract W-7405-ENG-36 for Los Alamos National Laboratory, which
!     is operated by the University of California for the
!     U.S. Department of Energy. The Government is granted for itself
!     and others acting on its behalf a paid-up, nonexclusive,
!     irrevocable worldwide license in this material to reproduce,
!     prepare derivative works, and perform publicly and display
!     publicly. Beginning five (5) years after October 10,2002 subject
!     to additional five-year worldwide renewals, the Government is
...
!     others to do so. NEITHER THE UNITED STATES NOR THE UNITED STATES
!     DEPARTMENT OF ENERGY, NOR THE UNIVERSITY OF CALIFORNIA, NOR ANY OF
...
!     special values
      ...
      PARAMETER(MPI_STATUS_IGNORE = -7)
      PARAMETER(MPI_STATUSES_IGNORE = -7)
