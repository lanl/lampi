...
void ADIOI_PANFS_ReadComplete(ADIO_Request *request, ADIO_Status *status, int *error_code)  
{
#ifndef NO_AIO
#ifndef PRINT_ERR_MSG
    static char myname[] = "ADIOI_PANFS_READCOMPLETE";
#endif
#ifdef AIO_SUN 
...
void ADIOI_PANFS_WriteComplete(ADIO_Request *request, ADIO_Status *status, int *error_code)  
{
    ADIOI_PANFS_ReadComplete(request, status, error_code);
}
