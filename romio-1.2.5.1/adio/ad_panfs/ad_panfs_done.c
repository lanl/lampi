...
int ADIOI_PANFS_ReadDone(ADIO_Request *request, ADIO_Status *status, int *error_code)  
{
#ifndef NO_AIO
    int done=0;
#ifndef PRINT_ERR_MSG
    static char myname[] = "ADIOI_PANFS_READDONE";
#endif
#ifdef AIO_SUN 
...
int ADIOI_PANFS_WriteDone(ADIO_Request *request, ADIO_Status *status, int *error_code)  
{
    return ADIOI_PANFS_ReadDone(request, status, error_code);
} 
