                ...
                ADIO_Offset offset, ADIO_Request *request, int *error_code)  
{
    ...
    static char myname[] = "ADIOI_PANFS_IREADCONTIG";
#endif
#endif
    ...
    ADIOI_PANFS_ReadContig(fd, buf, len, MPI_BYTE, file_ptr_type, offset, 
			 &status, error_code);  
    (*request)->queued = 0;
    ...
    err = ADIOI_PANFS_aio(fd, buf, len, offset, 0, &((*request)->handle));
...
/* call the blocking version. It is faster because it does data sieving. */
    ADIOI_PANFS_ReadStrided(fd, buf, count, datatype, file_ptr_type, 
