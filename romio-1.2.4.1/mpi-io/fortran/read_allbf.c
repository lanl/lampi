...
void pmpi_file_read_all_begin(void);
void mpi_file_read_all_begin(void);
/*  void pmpi_file_read_all_begin_(void);   this is the real function, below */
void mpi_file_read_all_begin_(void);   
void pmpi_file_read_all_begin__(void);
void mpi_file_read_all_begin__(void);
void PMPI_FILE_READ_ALL_BEGIN(void);
void MPI_FILE_READ_ALL_BEGIN(void);
...
#pragma weak mpi_file_read_all_begin = pmpi_file_read_all_begin_
/* #pragma weak mpi_file_read_all_begin_ = pmpi_file_read_all_begin_    ROMIO does this one */
