...
void pmpi_file_write_ordered_end(void);
void mpi_file_write_ordered_end(void);
/*  void pmpi_file_write_ordered_end_(void);   this is the real function, below */
void mpi_file_write_ordered_end_(void);   
void pmpi_file_write_ordered_end__(void);
void mpi_file_write_ordered_end__(void);
void PMPI_FILE_WRITE_ORDERED_END(void);
void MPI_FILE_WRITE_ORDERED_END(void);
...
#pragma weak mpi_file_write_ordered_end = pmpi_file_write_ordered_end_
/* #pragma weak mpi_file_write_ordered_end_ = pmpi_file_write_ordered_end_    ROMIO does this one */
