...
void pmpi_file_write_all(void);
void mpi_file_write_all(void);
/*  void pmpi_file_write_all_(void);   this is the real function, below */
void mpi_file_write_all_(void);   
void pmpi_file_write_all__(void);
void mpi_file_write_all__(void);
void PMPI_FILE_WRITE_ALL(void);
void MPI_FILE_WRITE_ALL(void);
...
#pragma weak mpi_file_write_all = pmpi_file_write_all_
/* #pragma weak mpi_file_write_all_ = pmpi_file_write_all_    ROMIO does this one */
