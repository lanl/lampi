...
void pmpi_file_get_position_shared(void);
void mpi_file_get_position_shared(void);
/*  void pmpi_file_get_position_shared_(void);   this is the real function, below */
void mpi_file_get_position_shared_(void);   
void pmpi_file_get_position_shared__(void);
void mpi_file_get_position_shared__(void);
void PMPI_FILE_GET_POSITION_SHARED(void);
void MPI_FILE_GET_POSITION_SHARED(void);
...
#pragma weak mpi_file_get_position_shared = pmpi_file_get_position_shared_
/* #pragma weak mpi_file_get_position_shared_ = pmpi_file_get_position_shared_    ROMIO does this one */
