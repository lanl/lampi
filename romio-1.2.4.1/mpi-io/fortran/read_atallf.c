...
void pmpi_file_read_at_all(void);
void mpi_file_read_at_all(void);
/*  void pmpi_file_read_at_all_(void);   this is the real function, below */
void mpi_file_read_at_all_(void);   
void pmpi_file_read_at_all__(void);
void mpi_file_read_at_all__(void);
void PMPI_FILE_READ_AT_ALL(void);
void MPI_FILE_READ_AT_ALL(void);
...
#pragma weak mpi_file_read_at_all = pmpi_file_read_at_all_
/* #pragma weak mpi_file_read_at_all_ = pmpi_file_read_at_all_    ROMIO does this one */
