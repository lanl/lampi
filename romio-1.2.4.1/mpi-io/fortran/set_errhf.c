...
void pmpi_file_set_errhandler(void);
void mpi_file_set_errhandler(void);
/*  void pmpi_file_set_errhandler_(void);   this is the real function, below */
void mpi_file_set_errhandler_(void);   
void pmpi_file_set_errhandler__(void);
void mpi_file_set_errhandler__(void);
void PMPI_FILE_SET_ERRHANDLER(void);
void MPI_FILE_SET_ERRHANDLER(void);
...
#pragma weak mpi_file_set_errhandler = pmpi_file_set_errhandler_
/* #pragma weak mpi_file_set_errhandler_ = pmpi_file_set_errhandler_    ROMIO does this one */
