...
void pmpi_file_iwrite_at(void);
void mpi_file_iwrite_at(void);
/*  void pmpi_file_iwrite_at_(void);   this is the real function, below */
void mpi_file_iwrite_at_(void);   
void pmpi_file_iwrite_at__(void);
void mpi_file_iwrite_at__(void);
void PMPI_FILE_IWRITE_AT(void);
void MPI_FILE_IWRITE_AT(void);
...
#pragma weak mpi_file_iwrite_at = pmpi_file_iwrite_at_
/* #pragma weak mpi_file_iwrite_at_ = pmpi_file_iwrite_at_    ROMIO does this one */
