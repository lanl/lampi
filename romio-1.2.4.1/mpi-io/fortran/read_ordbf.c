...
void pmpi_file_read_ordered_begin(void);
void mpi_file_read_ordered_begin(void);
/*  void pmpi_file_read_ordered_begin_(void);   this is the real function, below */
void mpi_file_read_ordered_begin_(void);   
void pmpi_file_read_ordered_begin__(void);
void mpi_file_read_ordered_begin__(void);
void PMPI_FILE_READ_ORDERED_BEGIN(void);
void MPI_FILE_READ_ORDERED_BEGIN(void);
