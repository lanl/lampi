...
% All three of the info keys can be specified when a file is opened
% with \texttt{MPI\_File\_open} or after the file is opened with
% \texttt{MPI\_File\_set\_info} or \texttt{MPI\_File\_set\_view}.
